...
public class ArticleHorizontalAdapter extends RecyclerView.Adapter<ArticleHorizontalAdapter.viewHolder> {

    private Context mContext;
    private List<Articles.ItemsArticles> articlesList;

    public ArticleHorizontalAdapter(Context context) {
    ...
    @NonNull
    @Override
    public ArticleHorizontalAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ArticleHorizontalAdapter.viewHolder holder, int position) {
        Picasso.get()
