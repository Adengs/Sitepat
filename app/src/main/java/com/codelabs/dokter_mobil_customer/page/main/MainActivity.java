...
import com.codelabs.dokter_mobil_customer.decoration.HorizontalItemDecoration;
...
public class MainActivity extends BaseActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.iv_car_monitoring)
    AppCompatImageView containerCarMonitoring;
    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.iv_support)
    AppCompatImageView containerSupport;
    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.iv_about)
    AppCompatImageView containerAbout;
    @SuppressLint("NonConstantResourceId")
