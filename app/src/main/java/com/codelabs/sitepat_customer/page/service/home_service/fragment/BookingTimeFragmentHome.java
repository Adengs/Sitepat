...
public class BookingTimeFragmentHome extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_booking_time_home, container, false);
    ...
    public void initSetup(){
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (etTime.getText().toString().isEmpty()){
                    ...
                    EventBus.getDefault().post(new NextHS3());
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EventBus.getDefault().post(new PreviousHS3());
            }
        });
